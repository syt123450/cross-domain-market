...
function getComment($commodityID, $pageID) {

    //use the commodityID and pageID to get commentData
...
function addComment($commodityID, $usrName, $commentContent) {

    //use the commodityID, usrName, commentContent to add comment
...
function addRate($commodityID, $usrName, $rate) {

    //use the commodityID, usrName, rate to add rate
...
function addToCart($usrID, $commodityID) {

    //use the usrID and commodityID to add the commodity for usr
